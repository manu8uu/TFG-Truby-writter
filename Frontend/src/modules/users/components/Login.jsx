        ...
        if (form.checkValidity()) {
           ...
           dispatch(
                actions.login(
                    userName.trim(),
                    password,
                    () => navigate('/users/UserHome'), // Redirección al loguearse con éxito
                    errors => setBackendErrors(errors) // Manejo de errores si falla el login
                )
            );
                ...
                >
                    <div className="text-center mb-4">
                        ...
                        <p className="text-muted small mb-0">
                            <FormattedMessage id="project.users.Login.subtitle" defaultMessage="Ingresa tus credenciales para continuar" />
                        </p>
                    </div>
                    ...
                    >
                        <Form.Group className="mb-3" controlId="userName">
                            ...
                            <InputGroup>
                                <InputGroup.Text 
                                    className="bg-light border-0 text-muted ps-3"
                        ...
                        <Button 
                            type="submit" 
                            className="w-100 py-2.5 border-0 text-white fw-semibold shadow-sm"
                            style={{ 
